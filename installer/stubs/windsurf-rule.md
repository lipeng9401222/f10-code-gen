...
# epoint-f10code-gen · Windsurf IDE 入口
...
_本入口由 `epoint-f10code-gen/installer/stubs/windsurf-rule.md` 模板生成，**不要直接改这里**。重新生成方式：`npx epoint-f10code-gen init` 或 `node epoint-f10code-gen/bin/cli.mjs init`。_
